...
|---|---|---|---|---|---|
| CHT-001 | CBA refinancing rate, 2023–2025 | line (single series) | DS-002 | presentations/CHT-001-cba-refinance-trajectory.svg | final |

## Presentations (RPT-NNN)

| ID | Title | Findings included | Charts included | QA | File | Status |
|---|---|---|---|---|---|---|
| RPT-001 | The CBA Refinancing Rate, 2023–2025 | — (built from DS-002 + cleaning log) | CHT-001 | — | presentations/RPT-001-cba-refinance-rate.md | final |
